...
if __name__ == '__main__':
    #################################################数据地址################################################################
    hisAcPath = r"/Users/hx/Desktop/12th/Data/LF-remove-alpha_avgnochange.tif"
    ...
    for ssp in scenario:
        ...
        ##########################################统计##############################################################
        print(">>>>> 统计 ", end="\n")
        classify = vcc_cal("AC_evaluation", hisAc, hisNPP, hisLUC, hisP, hisET, futureP, adP, process_num=None,
