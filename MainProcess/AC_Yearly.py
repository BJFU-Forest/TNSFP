...
if __name__ == '__main__':
    #################################################数据地址################################################################
    inputPath = r"/Volumes/FluxGroup/TNSP_Data/TNSP_Yearly_kNDVI_MODIS_2001-2021_500m/**/*.tif"
    luccPath = r"/Volumes/FluxGroup/TNSP_Data/TNSP_YearlyLandUse_MODIS_2001-2021_500m/" + "/"
    outputPath = r"/Volumes/WD_BLACK/AC_Yearly_2001_2021_group/" + "/"
    create_path(outputPath)
    group = 4  # 分组处理（内存不足时增大，默认为1）
    ...
    #                     # if year == "2018":
    #                     #     lucc = lucc[:, ::-1,:]
    #                     vegetation_type = [1, 2, 3, 4, 5, 6, 7, 10]
    ...
    #                                                process_num=8,
    #                                                backup_path=r"/Volumes/Focus Work/backup20" + "/")
    ...
    #                               process_num=8,
    #                               backup_path=r"/Volumes/WD_BLACK/backupYearly/" + "/")
