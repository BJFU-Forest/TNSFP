...
if __name__ == '__main__':
    ...
    outputPath = r"/Volumes/home/HDD/AC-Regression30/"
    ...
    #         #########################################统计##############################################################
    #         print(">>>>> 统计 ", end="\n")
    #         r, p = pearson_cal("stats_PearsonC", alphaM[3:, :, :], nppM[3:, :, :], process_num=8,
    #                            backup_path=r"/Volumes/home/HDD/backup/" + "/")
    ...
    #     ndvi.close()
    #     ac.close()
    #     state, min_ac = ndvi_change_test("kNDVI_change", matrix_ndvi, matrix_ac, trigger_index, process_num=30,
    #                                      backup_path=r"/Volumes/home/HDD/backup/")
