...
if __name__ == '__main__':
    ...
    outputPath = r"/Volumes/WD_BLACK/AC_Results/" + "/"
    ...
    #                     lat = np.linspace(ds.bounds.top, ds.bounds.bottom, ds.height).astype(
    #                         "float32") if lat is None else lat
    #                     lon = np.linspace(ds.bounds.left, ds.bounds.right, ds.width).astype(
    #                         "float32") if lon is None else lon
    ...
    #                     if year == "2018":
    #                         lucc = lucc[:, ::-1, :]
    #                     vegetation_type = [1, 2, 3, 4, 5, 6, 10, 12]
    ...
    # #                                                process_num=8,
    # #                                                backup_path=r"/Volumes/WD_BLACK/backup" + "/")
    ...
    #         ##########################################统计##############################################################
    #         print(">>>>> 统计 ", end="\n")
    #         avg, mk, sen = stats_cal("stats_" + val, matrix[46:, :, :], process_num=8,
    #                                  backup_path=r"/Volumes/WD_BLACK/backup" + "/")
