...
class CEEMDAN:
    ...
    **"Complete Ensemble Empirical Mode Decomposition with Adaptive Noise"**
    ...
    noise" (CEEMDAN) [Torres2011]_  is noise-assisted PyEMD technique.
    ...
    **Note** that some decompositions can take a while to complete. Please check
    ...
    .. [Colominas2014] M.A. Colominas, G. Schlotthauer, M.E. Torres,
        Improved complete ensemble PyEMD: A suitable tool for biomedical signal
