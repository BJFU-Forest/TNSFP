...
from Tools.pyEMD.splines import akima
...
class EMD:
    ...
    *Note:*
    Default and recommended package for PyEMD is PyEMD.py.
    This is meant to provide with the same results as MATLAB version of PyEMD,
